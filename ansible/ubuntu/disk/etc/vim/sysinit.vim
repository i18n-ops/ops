...
Plug 'i18n-fork/vim-svelte-plugin'
...
let g:coc_global_extensions = ['coc-svelte', 'coc-biome', 'coc-rust-analyzer', 'coc-json', 'coc-yaml', 'coc-python', 'coc-vetur']

let g:vim_svelte_plugin_use_pug = 1
let g:vim_svelte_plugin_use_coffee = 1
let g:vim_svelte_plugin_use_stylus = 1
...
\ [
\   {'filetype' : 'coffeescript', 'start' : '<script lang="coffee">', 'end' : '</script>'},
